...
import 'package:intro_flutter/pages/GhibliPage.dart';
import 'package:intro_flutter/pages/HomePage.dart';
import 'package:intro_flutter/pages/NextPage.dart';
import 'package:intro_flutter/pages/RecettePage.dart';
...
List<ButtonObject> menuButton = [
  ...
  ButtonObject(destination: NextPage(), label: "Mon Blog"),
  ButtonObject(destination: GhibliPage(), label: "Ma biblio"),
];
